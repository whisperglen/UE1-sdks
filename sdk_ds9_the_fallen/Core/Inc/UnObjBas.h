...
public:
	...
	virtual FName GetStateName(void);
	...
	virtual void IncrementLogs(void);
	virtual void IncrementWarnings(void);
	...
	virtual void debugs(int, char const*, ...);
    ...
    DECLARE_FUNCTION(execMultiply_RotatorRotator)
	...
	DECLARE_FUNCTION(execClearFlags)
