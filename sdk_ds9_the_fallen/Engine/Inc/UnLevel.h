...
class ENGINE_API ULevel : public ULevelBase
{
	...
	virtual UBOOL DestroyActor( AActor* Actor, UBOOL bNetForce=0, INT unk=0 );
	virtual void CleanupDestroyed( UBOOL bForce );
	virtual AActor* SpawnActor( UClass* Class, FName InName=NAME_None, AActor* Owner=NULL, class /*APawn*/AActor* Instigator = NULL, FVector Location = FVector(0, 0, 0), FRotator Rotation = FRotator(0, 0, 0), AActor* Template = NULL, UBOOL bNoCollisionFail = 0, UBOOL bRemoteOwned = 0, AActor* unk = NULL);
	...
	virtual UBOOL AdjustSpot( FVector &Adjusted, FVector TraceDest, FLOAT TraceLen, FVector unk0, INT unk1, FCheckResult &Hit );
